...
type ViewMode = 'list' | 'create-admin' | 'create-technician';
...
export function UsersView() {
  ...
  const calculateStats = () => {
    setStats({
      ...
      technicians: profiles.filter((p) => p.role === 'technician').length,
